...
public class ItemRecommendGoodsAdapter extends BaseAdapter {
    ...
    private List<FragmentMedcinesInfo.RecommendGoodsBean> data;

    public ItemRecommendGoodsAdapter(Context context, List<FragmentMedcinesInfo.RecommendGoodsBean> data) {
        this.context = context;
        this.data = data;
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public void setData(List<FragmentMedcinesInfo.RecommendGoodsBean> data) {
        this.data = data;
        notifyDataSetChanged();
    }

    public void addData(List<FragmentMedcinesInfo.RecommendGoodsBean> data) {
        this.data.addAll(data);
        notifyDataSetChanged();
    }

    public List<FragmentMedcinesInfo.RecommendGoodsBean> getData() {
        return this.data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FragmentMedcinesInfo.RecommendGoodsBean recommendGoods = data.get(position);
