...
//    public LinearLayout ll_recommend;
    ...
    @ViewInject(R.id.ll_current_goods)
    private LinearLayout ll_current_goods;
    @ViewInject(R.id.ll_current_number)
...
//    private MyAdapter adapter;
    ...
    @Event(value = {R.id.fab_up_slide, R.id.ll_comment, R.id.ll_pull_up, R.id.ll_goods_detail, R.id.ll_goods_config, R.id.shoucang, R.id.tv_current_goods,
...
//                it.putExtra( "imgs",checkInchModel.getImage() );
//                startActivity( it );
                break;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ll_current_number.setVisibility(View.GONE);
        ll_current_goods.setVisibility(View.VISIBLE);
...
//        }, handledData );
    ...
    public void updeta(CommodityDetailsModel commodityDetailsModel) {
        ...
        tv_goods_title.setText(model.getTitle());
        tv_new_price.setText(model.getColorList().get(0).getSizeList().get(0).getCostMoney() + "");
...
//        images[0] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath();
//        images[1] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath2();
//        images[2] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath3();
//        images[3] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath4();
//        images[4] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath5();
//        images[5] = "http://www.lanjiutian.com/upload/images" + model.getColorList().get(0).getSizeList().get(0).getImgPath6();
