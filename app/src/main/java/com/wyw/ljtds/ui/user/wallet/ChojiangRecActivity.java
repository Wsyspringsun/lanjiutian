...
public class ChojiangRecActivity extends BaseActivityFragment {
    @Override
    protected Fragment createFragment() {
        return ChoJiangRecFragment.newInstance();
    }

    public static Intent getIntent(Context context) {
        Intent it = new Intent(context, ChojiangRecActivity.class);
        return it;
    }
}
