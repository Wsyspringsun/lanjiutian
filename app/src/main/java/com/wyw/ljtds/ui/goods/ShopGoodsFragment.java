 ...
 * {@link ShopGoodsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ShopGoodsFragment#newInstance} factory method to
...
//        paixu4_tv.setTextColor(getResources().getColor(R.color.font_black2));
     ...
     */
    public static ShopGoodsFragment newInstance(String shopid, String medType) {
