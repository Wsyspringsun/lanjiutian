...
public class FragmentHome extends BaseFragment {
    ...
    @Event(value = {R.id.ll_search, R.id.zxing, R.id.fenlei1, R.id.fenlei2, R.id.fenlei3, R.id.fenlei4, R.id.fenlei5,
            R.id.right_img, R.id.fenlei6, R.id.fenlei7, R.id.img_home_active_goods, R.id.fenlei8})
    private void onclick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.fenlei8:
                it = new Intent(getActivity(), ActivityGoodsList.class);
                it.putExtra("search", "家用电器%手机数码%办公用品");
                startActivity(it);
                break;
...
//                    .setOnItemClickListener(R.id.sdv_item_head_img, new AdapterView.OnItemClickListener() {
//                        @Override
//                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
//                            Log.e(AppConfig.ERR_TAG, "item click");
//                            if (adapter != null) {
//                                HomePageModel1.RecommendComms itemData = adapter.getData().get(position);
//                                String typeId = itemData.getCommodityTypeId();
//                                Log.e(AppConfig.ERR_TAG, "item click" + typeId);
//                                Intent it = ActivityGoodsList.getStartMeIntent(getActivity(), typeId);
//                                getActivity().startActivity(it);
