...
import com.wyw.ljtds.widget.body.AnimatedPathView;
...
public class RegionPathView {
    ...
    private void init(){
        ...
        regionRadius = SizeConvertUtil.dip2px(RegionParam.REGION_WIDTH / 2f);
        pathOffsetX = SizeConvertUtil.dip2px(RegionParam.PATH_OFFSET_X / 2f);
    }
