package com.wyw.ljtds.widget.logistics;
...
import com.wyw.ljtds.widget.logistics.item.StepNodeItemDecoration;
...
public class StepView extends RecyclerView {
    ...
    public StepView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        leftMargin = SizeConvertUtil.dpTopx(context, DEFAULT_LEFT_MARGIN);
        rightMargin =SizeConvertUtil.dpTopx(context, DEFAULT_RIGHT_MARGIN);
        lineWidth = SizeConvertUtil.dpTopx(context, DEFAULT_LINE_WIDTH);
        radius = SizeConvertUtil.dpTopx(context, DEFAULT_DOT_RADIUS);
