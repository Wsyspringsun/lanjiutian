package com.wyw.ljtds.widget.logistics.item;
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (builder.orientation == LinearLayoutManager.VERTICAL) {
                left = child.getLeft() - params.leftMargin + transitionX + SizeConvertUtil.dpTopx(parent.getContext(), builder.leftMargin);
                top = child.getBottom() + params.bottomMargin;
                right = child.getRight() + params.rightMargin - SizeConvertUtil.dpTopx(parent.getContext(), builder.rightMargin);
                bottom = top + builder.dividerHeight + transitionY;
            } else {
                top = child.getTop() - params.topMargin + SizeConvertUtil.dpTopx(parent.getContext(), builder.topMargin);
                bottom = child.getBottom() + params.bottomMargin + transitionY - SizeConvertUtil.dpTopx(parent.getContext(), builder.bottomMargin);
