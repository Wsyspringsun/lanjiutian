...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        //设置画笔颜色
        selectPaint.setColor(ContextCompat.getColor(mContext, R.color.base_bar));
        //设置文字大小
        selectPaint.setTextSize( SizeConvertUtil.spTopx(mContext, 20));
        ...
        //设置画笔颜色
        unSelectPaint.setColor(ContextCompat.getColor(mContext, R.color.font_black2));
        //设置文字大小
        unSelectPaint.setTextSize(SizeConvertUtil.spTopx(mContext, 18));
        ...
        //设置画笔颜色
        centerLinePaint.setColor(ContextCompat.getColor(mContext, R.color.basebackground));
