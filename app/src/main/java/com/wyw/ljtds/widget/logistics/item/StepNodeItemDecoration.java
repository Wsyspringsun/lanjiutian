...
public class StepNodeItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void initPaint() {
        ...
        ringRadius = radius + SizeConvertUtil.dpTopx(mBuilder.context, DEFAULT_DOT_STROKE_WIDTH);
        space = SizeConvertUtil.dpTopx(mBuilder.context, DEFAULT_SPACE);
        ...
        mDotHighRingPaint.setColor(SizeConvertUtil.getColorWithAlpha(0.3f, mBuilder.highDotColor));
