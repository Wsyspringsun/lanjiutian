...
//    }
    ...
    private void numberChange(){
        if(mOnNumberListener!=null) mOnNumberListener.OnNumberChange( getNumber() );
    }
    ...
    public NumberButton setOnNumberListener(OnNumberListener onNumberListener){
