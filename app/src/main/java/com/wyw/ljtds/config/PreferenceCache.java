...
public class PreferenceCache {
    ...
    public static void putNearestKeywords(String keys) {
        SharedPreferences pref = getSharedPreferences();

        Editor editor = pref.edit();
        editor.putString(PF_NEAREST_KEYWORDS, keys);
        editor.commit();
    }
    ...
    public static void putNearestKeywords4Medicine(String keys) {
        SharedPreferences pref = getSharedPreferences();

        Editor editor = pref.edit();
        editor.putString(PF_NEAREST_KEYWORDS_MEDICINE, keys);
        editor.commit();
    }
