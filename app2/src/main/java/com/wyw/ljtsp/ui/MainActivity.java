...
import com.wyw.ljtsp.model.LogOutModel;
import com.wyw.ljtsp.model.UserInfoModel;
...
//        RequestParams params = new RequestParams("http://www.lanjiutian.com/ljt_mobile_store/v/user/groupAccount");
        RequestParams params = new RequestParams(AppConfig.WEB_DOMAIN + "/v/user/groupAccount");
