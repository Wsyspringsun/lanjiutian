...
public class PreferenceCache {
    ...
    public static final String PF_USERID = "adminUserId";
    ...
    public static final String PF_OIDGROUPID = "oidGroupId";
    ...
    public static void putUserId(String id) {
        SharedPreferences pref = getSharedPreferences();
        Editor editor = pref.edit();
        editor.putString(PF_USERID, id);
        editor.commit();
    }

    public static String getUserId() {
        return getSharedPreferences().getString(PF_USERID, "");
    }

    public static void putOidGroupId(String id) {
        SharedPreferences pref = getSharedPreferences();
        Editor editor = pref.edit();
        editor.putString(PF_OIDGROUPID, id);
        editor.commit();
    }

    public static String getOidGroupId() {
        return getSharedPreferences().getString(PF_OIDGROUPID, "");
    }
